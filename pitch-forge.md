...
>
> **Relationship to Product Blueprint:** If a Product Blueprint exists for this project, use it as a reference to pre-fill business context. If not, this interview stands alone — no codebase or technical spec required.
>
...
- **Story first, features never.** Investors buy narratives, not feature lists. "We eliminate cash handling for 50,000 jeepney drivers" beats "We have QR-code boarding with GPS-based fare calculation."
...
- **Challenge the founder.** Ask the hard questions investors will ask: "Why won't Google/Grab just copy this?" "What if your first 100 users hate it?" "Why are YOU the right person to build this?"
- **Use Product Blueprint if available.** If a Product Blueprint exists, pre-fill what you can and skip redundant questions. Focus interview time on business narrative, not product details.
...
Total: ~25 minutes of focused conversation.
...
1. **Does a Product Blueprint exist for this project?**
   - If YES: Read it. Pre-fill the founder's answers for Rounds 1-2 from Sections 1-2 of the Blueprint. Start the interview at Round 2 or 3, confirming pre-filled content: "From your Product Blueprint, I have [summary]. Does this still hold for how you'd pitch it to investors?"
   - If NO: Start from Round 1.

2. **Does the founder have an existing pitch deck or one-pager?**
...
2. **"Tell me about a REAL person who has this problem. Give them a name. What's their day like?"**
   ...
   - Push for emotional specificity: "Maria is a commuter in Manila who spends 20 minutes every morning trying to break a 500-peso bill because jeepney drivers can't make change."
   - If the founder gives you a persona from the Product Blueprint, push deeper: "That's the role description. Now make them a real person. Name, age, daily frustration."

3. **"Now describe Maria's day AFTER she starts using your product."**
...
- **Problem Narrative:** The "Maria" story — emotional, specific, relatable
- **Solution Narrative:** Maria's transformed experience
...
6. **"How much is each user worth to you per year? (Even a rough guess)"**
   - This is the start of unit economics. Revenue per user × addressable users = market size in dollars.
...
7. **"Why is this a GROWING market? What trend is in your favor?"**
   - Investors want tailwinds. Digital payments growing? Smartphone adoption rising? Regulation pushing digitization?
   - If the market is flat: "Is there a trigger event that will accelerate adoption?" (New law, infrastructure change, cultural shift)

8. **"Where do you launch first, and how do you expand?"**
   - Go-to-market geography and expansion path.
   - This should align with the Product Blueprint's target market if one exists.

### What You're Producing
- **Market Size Slide:** TAM / SAM / SOM with dollar values
...
Example: "There are 55,000 jeepneys in Metro Manila carrying ~4M commuters daily. At ₱15 average fare, that's ₱60M/day or ₱22B/year. At a 5% take rate, your SAM is ₱1.1B/year (~$20M)."
...
10. **"Walk me through the money math for ONE user."**
    ...
    - If they don't know: "Let's estimate. If you spend ₱0 on marketing and rely on word-of-mouth for the first 1,000 users, what does organic acquisition look like?"

11. **"Do you have ANY traction? Users, revenue, waitlist, LOIs, pilots, partnerships?"**
    - Even pre-launch traction matters: "50 drivers signed up for the waitlist", "3 jeepney operators signed LOIs", "We ran a 2-week pilot with 200 users."
...
14. **"What's your unfair advantage? Why will YOU win this?"**
    - Types of moat (guide them):
      ...
      - **Speed:** You're 2 years ahead and moving fast
...
15. **"What happens if [biggest tech company in your space] decides to build this?"**
    - The "Google question." Every founder gets it.
...
**Writing Rules:**
- No jargon. "Real-time GPS tracking" → "Passengers see exactly where their jeepney is."
- No architecture. "Socket.io WebSocket" → never mentioned.
- Lead with impact. "20% discount automatically applied" → "Senior citizens save 20% on every ride — no arguing with drivers."
...
> **Agent instruction:** Use this structure for the final document. All content should be investor-ready — non-technical, narrative-driven, concise.
...
[2-3 paragraphs. Tell the story of a real person (or realistic persona) who suffers from this problem daily. Make it emotional and specific. End with the cost — time, money, frustration, risk — that this person bears.]

### The Problem at Scale

[1 paragraph. Zoom out from the individual to the market. "Maria isn't alone. [X million] people face this every day, costing [Y] in [lost time / money / safety / productivity]."]
...
| Segment | Size | Basis |
|---------|------|-------|
| **TAM** (Total Addressable Market) | [$ amount] | [How calculated] |
| **SAM** (Serviceable Addressable Market) | [$ amount] | [Geographic/segment filter] |
| **SOM** (Year 1-2 Target) | [$ amount] | [Realistic capture estimate] |
...
[1-2 sentences of narrative context. "We launched a 2-week pilot with 3 jeepney routes and saw..." or "We're pre-launch but have secured..."]
...
| 2 — Problem | Maria's story + problem at scale | The Problem |
...
- [ ] Market size has actual dollar amounts (even rough estimates), not "it's a big market"
...
- [ ] The Ask has a specific dollar amount, instrument, and use-of-funds breakdown
