...
13. **"What's the single most important action in your product? The one thing that, if it breaks, the whole product is useless?"**
    - For Uber: completing a ride. For Airbnb: booking a stay. For Jeepi: boarding and paying a fare.
...
23. **"Are there any financial regulations that apply?"**
    - Guide by region:
      - **Philippines:** BSP e-money, AMLA, BIR/VAT
...
- **Marketplace/payments:** Idempotency keys, webhook verification, transaction limits, AMLA thresholds
