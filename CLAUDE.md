...
- **Branch**: `main`. Clean.
- **Active work**: Slate clean. Generic Forge v2 pivot is fully merged (5 commits, e6d6fa6 → c38b5d3, plus 3 follow-ups: 5839140 path fix, a773f36 Codex-CLI-driven YAML fix, 11f3a9b absorb three AGENTS.md learnings into `global-patterns.md`). Pivot blueprint moved to `archive/maxima-pivot-plan.md` during the 2026-05-10 /purge pass.
