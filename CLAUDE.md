...
- **Branch**: `main`. Ahead of origin by the per-skill model-ceiling commit (24 skill hints + deploy-time frontmatter injection + wrap hot-path gate) and the token-burn lever commit; WA-001 retirement (`18b331d`) and purge pass (`9560e8d`) already landed.
...
- **Earlier history** (2026-04-23 → 2026-05-10): see `memory/recent-history.md`. 8 entries archived during the 2026-04-27 wrap, 5 more during 2026-04-30, 3 more during the first 2026-05-04 wrap, 1 more during the second, 1 more during the third, 2 more (Pitch refactor + lineage indexing) during the fourth 2026-05-04 wrap (probe/prime stack-anchoring), 3 more (probe/prime stack-anchoring + /prime opus convention + AGENTS.md absorb cycle) during the 2026-05-10 wrap, and 2 more (Phase C verification + /purge cleansing pass) during the 2026-06-13 WA-001-retirement wrap.
