...
- **Branch**: `main`. Pushed through `242c5e8`. (This line is itself a mirror of push state — it claimed the 2026-07-19 stack-guide commit was pending long after it had shipped. Prefer `git log origin/main..HEAD` over trusting it.)
