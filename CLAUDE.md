...
- **Recent**: Codified scripts/ vs dev/ convention — scripts/ is production-only (build, deploy, release, CI), dev/ is local dev tooling (restart.sh, kill-zombies.sh, emulator.js). Updated /srs, stack-guide, forge-conventions.
- **Pending**: None
