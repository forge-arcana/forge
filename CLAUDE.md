...
- **Branch**: `main`. Ahead of origin by the token-burn lever commit (token monitor + compressor + lean evidence); WA-001 retirement (`18b331d`) and purge pass (`9560e8d`) already landed.
