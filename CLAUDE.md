...
- **Recent**: Fix contributor attribution in /cast — `forge-status.sh` now includes author name in skill Change Details output, cast SKILL.md explicitly requires using git authors for skill rows.
