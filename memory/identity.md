...
Six forge actions, each an art with a specialist persona. Each grows sharper with every use through a self-improving learning loop.

1. **`/prime`** — ignite the idea, give it form through to blueprint
2. **`/probe`** — challenge the architecture against best practices
3. **`/poke`** — find the cracks, tech debt review
