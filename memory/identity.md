...
7. **`/pitch`** — The Founder's Other Voice. Fuses Opus + Vow + Touchstone into ONE Pitch — seven sections (The Bet, The Wound, The Inversion, The Field, The Stake, The Signal, The Stand) in the founder's voice, with ballpark numbers grounding viability. The same Pitch serves founder, cofounder, and investor; only the room differs. On `--critique`, a VC partner who has evaluated hundreds of companies runs a seven-dimension review pass that stress-tests the Pitch before external persuasion. Asks what matters before resources commit: Is the problem real? Is the value prop durable? Can the unit economics work? What kills this?
