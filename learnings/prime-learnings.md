...
**Learning**: When a founder is building for an organization they don't operate themselves and doesn't know internal details (billing structure, staffing, workflows), they still reveal critical design constraints through their observations. Offhand remarks like "the team handles their own scheduling" (= no dedicated coordinator, so the tool must be self-service) or "they have a dedicated collections role" (= billing pain is acute) are more valuable than detailed org charts — they reveal what the founder has noticed as broken or noteworthy.
