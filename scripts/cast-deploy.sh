#!/usr/bin/env bash
# cast-deploy.sh — Deploy forge skills (and runtime scripts) to membrane (~/.claude/)
...
#   cast-deploy.sh --scripts                           — deploy runtime scripts to ~/.claude/scripts/
...
MEMBRANE_SCRIPTS="$HOME/.claude/scripts"

# Runtime scripts to deploy to ~/.claude/scripts/ (manifest — explicit, no globbing).
...
# --- Scripts mode: deploy runtime scripts to ~/.claude/scripts/ ---
deploy_scripts() {
