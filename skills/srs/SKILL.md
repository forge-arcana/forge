...
3. Read `code/stack-guide.md` from forge repo (resolve forge path from `~/.claude/CLAUDE.md` `forge-path:` line, fallback `/root/dev/forge`) for reference architecture
