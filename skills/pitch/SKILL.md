---
name: pitch
description: VC-style business model critique at any lifecycle stage — market, value proposition, revenue model, moat, GTM, and kill conditions. Self-improving.
user-invocable: true
---
