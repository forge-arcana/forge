...
Run the full CI/CD pipeline locally. No GitHub Actions runners, no YAML, no waiting. Claude fixes failures in real-time.
...
- `production`: use `AskUserQuestion` — "Deploying to PRODUCTION. Confirm?" with options "Yes, deploy" / "Abort"
