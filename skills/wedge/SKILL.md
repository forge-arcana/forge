...
- [`<forge>/skills/wedge/family-tone-archetypes.md`](family-tone-archetypes.md) marked as an **optional reference shelf** — vocabulary the apprentice MAY draw from to ground craft, MAY invent against, or MAY ignore. Family × Tone is no longer the commission grammar; the lens is.
...
When the user picks **Regenerate**, capture *why* before re-spawning. Use `AskUserQuestion` (or accept freeform input via Other) to gather a structured feedback brief:
...
The Family × Tone reference shelf at <forge>/skills/wedge/family-tone-archetypes.md is OPTIONAL VOCABULARY — not your commission. You MAY draw a pairing from it to ground craft, MAY invent a vocabulary the shelf doesn't name, or MAY work without shelf reference at all. The lens leads. If the shelf's gravity pulls you toward a pairing that doesn't serve your lens, refuse it.
