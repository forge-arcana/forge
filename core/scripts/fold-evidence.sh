...
# ============================================================
# Section 3: Membrane State (user's $MEMBRANE/)
# ============================================================
echo "# Section 3: Membrane Learnings"
echo ""

MEMBRANE_LEARNINGS="$MEMBRANE/learnings"
...
MEMBRANE_MEMORY="$MEMBRANE/memory"
...
echo '```'
cat "$MEMBRANE/.last-cast.json" 2>/dev/null || echo "(not found)"
echo '```'
echo ""
